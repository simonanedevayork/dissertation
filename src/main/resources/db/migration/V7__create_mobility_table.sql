...
(
    ...
    MB_LIMPING BOOLEAN CONSTRAINT NN_MOBILITY_LIMPING NOT NULL,
    MB_RISES_LEG BOOLEAN CONSTRAINT NN_MOBILITY_RISES_LEG NOT NULL,
    MB_LACK_OF_ACTIVITY BOOLEAN CONSTRAINT NN_MOBILITY_LACK_OF_ACTIVITY NOT NULL,
    MB_PLAYFULNESS BOOLEAN CONSTRAINT NN_MOBILITY_PLAYFULNESS NOT NULL,
    MB_STANDING_DIFFICULTY BOOLEAN CONSTRAINT NN_MOBILITY_STANDING_DIFFICULTY NOT NULL,
    MB_CLIMBING_STAIRS BOOLEAN CONSTRAINT NN_MOBILITY_CLIMBING_STAIRS NOT NULL,
    MB_JUMPING BOOLEAN CONSTRAINT NN_MOBILITY_JUMPING NOT NULL,
