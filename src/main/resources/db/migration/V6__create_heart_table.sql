CREATE TABLE HEART
(
    HT_ID VARCHAR(16) CONSTRAINT NN_HEART_ID NOT NULL,
    HT_DOG_ID VARCHAR(16) CONSTRAINT NN_HEART_DOG_ID NOT NULL,
    HT_FATIGUE BOOLEAN CONSTRAINT NN_HEART_FATIGUE NOT NULL,
    HT_COUGHING BOOLEAN CONSTRAINT NN_HEART_COUGHING NOT NULL,
    HT_MURMURS VARCHAR(8) CONSTRAINT NN_HEART_MURMURS NOT NULL,
    HT_HEART_RATE NUMERIC(5,2) CONSTRAINT NN_HEART_RATE,
    HT_BREATHING_RATE NUMERIC(5,2) CONSTRAINT NN_HEART_BREATHING_RATE,
