...
(
    PD_PARTICIPANT_ID VARCHAR(16) CONSTRAINT NN_PD_PARTICIPANT_ID NOT NULL,
    PD_EMAIL VARCHAR(255) CONSTRAINT UQ_PD_EMAIL UNIQUE,
    PD_PASSWORD VARCHAR(128) CONSTRAINT  NN_PD_PASSWORD NOT NULL,
